      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 backdrop-blur-sm">
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-full bg-white px-4 py-3 text-sm font-semibold text-black transition-all hover:bg-zinc-200"
          >
